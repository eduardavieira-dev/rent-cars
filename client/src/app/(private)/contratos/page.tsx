    ...
    useEffect(() => {
        async function load(): Promise<void> {
            try {
                ...
                const data: ContractResponse[] = Array.isArray(response.data)
                    ? response.data
    ...
    return (
        <section className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold">Contratos</h1>
                <p className="text-muted-foreground">
                    Contratos ativos e rescindidos relacionados à sua operação.
                </p>
            </div>
                    ...
                    >
                        <div className="space-y-1">
                            ...
                            <p className="text-muted-foreground text-sm">
                                Placa: {contract.vehiclePlate} • Cliente: {contract.clientName}
                            </p>
                        ...
                        <div className="text-right">
                            ...
                            {contract.creditRequested && (
                                <p className="text-muted-foreground text-xs">Crédito solicitado</p>
                            )}
                        </div>
                    </Link>
                ))}
