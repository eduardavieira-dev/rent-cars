...
const STEPS = [{ label: 'Dados pessoais' }, { label: 'Endereço' }, { label: 'Senha' }];
        ...
        try {
            ...
            if (!viaCepData.erro) {
                setForm((prev) => ({
                    ...
                    neighborhood: viaCepData.bairro ?? prev.neighborhood,
