...
import { Building, Eye, EyeOff, Hash, Landmark, Lock, Mail, Phone } from 'lucide-react';
...
const step1Schema = z.object({
    name: z.string().min(3, 'O nome do banco deve ter no mínimo 3 caracteres.'),
    code: z
        .string()
        .refine(
...
const STEPS = [{ label: 'Dados do banco' }, { label: 'Senha' }];
